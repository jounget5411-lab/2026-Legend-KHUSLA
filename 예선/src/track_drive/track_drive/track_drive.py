...
class TrackDriverNode(Node):
    ...
    def cam_callback(self, data):
        ...
        self.get_logger().info(f"CAMERA received: {self.image.shape}")
    
    #=============================================
    # 라이다 토픽을 수신하는 콜백 함수
    #=============================================
    def lidar_callback(self, msg):
        self.lidar_ranges = msg.ranges   #msg.ranges는 라이다의 거리값 배열, 이 값을 self.lidar_ranges에 저장하여 나중에 사용할 수 있도록 함
        self.get_logger().info(f"LIDAR received: {len(msg.ranges)} points")
